...
class Grades:
    ...
    def __init__(self, quiz_1=None, quiz_2=None, quiz_3=None, midterm=None, project=None, final=None) -> None:
        """
    ...
    def set_all(self, quiz_1=None, quiz_2=None, quiz_3=None, midterm=None, project=None, final=None):
        """
    ...
    def __str__(self) -> str:
        ...
        if self.quiz_3 is not None:
            grades.append(f'Quiz 3: {self.quiz_3}')
